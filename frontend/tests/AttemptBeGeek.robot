...
${LONG_DESC}        Instalo Distros Ubuntu, Debian, ElementaryOS, PopOS, Linux Mint, Kurumin, Mandrake, Connectiva, Fedora, CenOS, Slackware, Gentoo, Archlinux, Kubuntu, Xubuntu, Suze, Mandriva, Edubuntu, KaleOS, Sabayon,Linux, Manjaro Linux, BigLinux, ZorinOS, Unity 234 Unit 234       
