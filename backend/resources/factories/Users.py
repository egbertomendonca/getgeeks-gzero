...
def factory_be_geek():
    return {
        'name': 'Joao Lucas',
        'email': 'joao@qaninjaxx.com.br',
        'password': 'pwd123',
        'geek_profile': {
            'whatsapp': '11999999999',
            'desc': 'Seu computador está lento? Reiniciando do nada? Talvez seja um virus, lfjdsajl aslfjsalj asldfjsalfjsa lsjaflsafj lsfdasf',
            'printer_repair': 'Sim',
            'work': 'Presencial',
            'cost': '100'
        }
